...
const Topbar = (props) => {
  ...
  return (
    <nav className="w-full h-20 border-b border-b-white/10 fixed top-0 left-0 pl-4 md:pl-60 py-4 pr-4 bg-sidebar z-98 flex justify-between items-center transition-all duration-500">
