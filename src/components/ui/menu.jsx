...
const MenuList = (props) => {
  ...
  return (
    <Link
      href={href}
      className={`w-full px-4 py-2 text-xs text-white/80 flex justify-start items-center gap-2 group hover:bg-accent/10 border-l-2  hover:border-l-accent ${isActive ? "bg-accent/10 border-l-accent" : "border-l-sidebar"}`}
    >
